...
class CommentDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    parent_comment: Field::BelongsTo.with_options(class_name: "Comment"),
    children_comments: Field::HasMany.with_options(class_name: "Comment"),
    id: Field::Number,
    parent_comment_id: Field::Number,
    body: Field::Text,
